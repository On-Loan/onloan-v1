...
const Sidebar = () => {
  ...
  return (
    <aside className="w-72 bg-white dark:bg-navy/95 h-full flex flex-col border-r border-gray-200 dark:border-navy/50 shadow-xl">
      <div className="p-6">
      ...
      <nav className="flex-1 px-4">
        <ul className="space-y-2">
          <li>
            <Link to="/dashboard/borrow" className={navLinkClass("/dashboard/borrow")}>
              <FaHandHoldingUsd className={`text-xl ${isActive("/dashboard/borrow") ? "text-lime" : ""}`} />
              <span>Borrow</span>
            </Link>
          </li>
          <li>
            <Link to="/dashboard/lend" className={navLinkClass("/dashboard/lend")}>
              <FaMoneyCheck className={`text-xl ${isActive("/dashboard/lend") ? "text-lime" : ""}`} />
              <span>Lend</span>
            </Link>
          </li>
          <li>
            <Link to="/dashboard/stats" className={navLinkClass("/dashboard/stats")}>
              <FaChartLine className={`text-xl ${isActive("/dashboard/stats") ? "text-lime" : ""}`} />
              <span>Stats & Tracking</span>
            </Link>
          </li>
          <li>
            <Link to="/dashboard/history" className={navLinkClass("/dashboard/history")}>
